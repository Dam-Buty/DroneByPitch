...
/* SKYFX*/
    ...
    */
    ...
    result = FMOD_System_CreateSound(system, 0, FMOD_2D | FMOD_DEFAULT | FMOD_LOOP_NORMAL | FMOD_OPENUSER, &exinfo, &sound);
    ERRCHECK(result);
    ...
    */
    printf("=========================================================================\n");
    printf("Pitch detection example.  Copyright (c) Firelight Technologies 2004-2010.\n");
    printf("=========================================================================\n");
    printf("\n");
    ...
    //Sleep(1000);                         /* Give it some time to record something */
	ERRCHECK(result);
	...
	while((result == FMOD_OK)&&(key != 97)); //97 = 'a' et 27 = "échap"
    ...
    // result = FMOD_System_PlaySound(system, sound, FMOD_CHANNEL_FREE, FALSE, &channel);
    // ERRCHECK(result);
	...
	// FMOD_Sound_GetLength(sound, &length, FMOD_TIMEUNIT_PCMBYTES);
